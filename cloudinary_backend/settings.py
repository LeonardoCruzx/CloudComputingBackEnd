"""
Django settings for cloudinary_backend project.
...
SECRET_KEY = 'django-insecure-1hsh%qy-spc=c0#l4u=r-1^_muoy-b=*+=2poz7n837u3y)k**'
...
WSGI_APPLICATION = 'cloudinary_backend.wsgi.application'
